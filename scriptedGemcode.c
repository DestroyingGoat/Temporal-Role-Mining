...
// MODIFIED: Accepts full paths directly
    ...
    while (1) {
        ...
        for (int u = 1; u <= ds->num_users; u++) {
            ...
            for (int k = 0; k < ucount; k++) {
                ...
                // ================== START OF FIX (Retained from your provided code) ==================
...
// MODIFIED: Arguments parsing with Automatic Prefix
int main(int argc, char *argv[]) {
    ...
    // Combine DATA_FOLDER ("datasets/") with filename ("apj.txt")
